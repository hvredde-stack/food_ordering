...
console.log(`\n[Live URLs to test]`);
for (const r of restaurants) {
  console.log(`  Admin:    https://tapserve.ca/${r.slug}/admin`);
  console.log(`  Settings: https://tapserve.ca/${r.slug}/admin/settings`);
  console.log(`  Kitchen:  https://tapserve.ca/${r.slug}/kitchen`);
  if (r.takeout_code) {
    console.log(`  Takeout:  https://tapserve.ca/${r.slug}/to/${r.takeout_code}`);
  }
}
